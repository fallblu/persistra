...
def execution_replay() -> ExecutionReplayResult:
    ...
    valuations = pd.DataFrame(
        {
            ...
            "net_market_value": [0.0, 642.0, 630.0, 212.0],
    ...
    completion = RunCompletion(
        ...
        net_market_value_micros=212_000_000,
        long_market_value_micros=212_000_000,
        short_market_value_micros=0,
        gross_exposure_micros=212_000_000,
        cost_basis_micros=206_289_334,
        realized_pnl_micros=6_751_334,
        unrealized_pnl_micros=5_710_666,
        equity_micros=10_012_462_000,
        dividend_pnl_micros=0,
        execution_fees_micros=1_538_000,
        borrow_fees_micros=0,
    ...
    return ExecutionReplayResult(
        ...
        base_currency="USD",
        initial_cash_balances=pd.DataFrame(
            {"currency": ["USD"], "amount": [10_000.0], "amount_micros": [10_000_000_000]}
        ),
        initial_equity=10_000.0,
        initial_equity_micros=10_000_000_000,
    )
